...
public final class FragmentDadoFragmentBinding implements ViewBinding {
  @NonNull
  private final ConstraintLayout rootView;

  @NonNull
  public final ConstraintLayout diceFrameLayout;
  ...
  private FragmentDadoFragmentBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout diceFrameLayout, @NonNull LinearLayout diceLayout,
    ...
    this.diceFrameLayout = diceFrameLayout;
  ...
  @NonNull
  public static FragmentDadoFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentDadoFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment__dado_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentDadoFragmentBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      ConstraintLayout diceFrameLayout = (ConstraintLayout) rootView;
      ...
      return new FragmentDadoFragmentBinding((ConstraintLayout) rootView, diceFrameLayout,
          diceLayout, diceNumber, leftDiceNumber, oneDice, rightDiceNumber, roll, twoDices);
    }
